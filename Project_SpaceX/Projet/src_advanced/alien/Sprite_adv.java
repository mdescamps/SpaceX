...
public class Sprite_adv implements Serializable {
	 ...
	 */
	public Sprite_adv(String path, double width, double height, double minX, double minY, double maxX, double maxY) {
	 ...
	 */
	public Sprite_adv(Sprite_adv s) {
		image = s.image;
		width = s.width;
		height = s.height;
		maxX = s.maxX;
	 ...
	 */
	public boolean intersects(Sprite_adv s) {
	 ...
	 */
	public boolean intersectsPlanet(Sprite_adv s) {
