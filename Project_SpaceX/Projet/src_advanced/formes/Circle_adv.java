...
public class Circle_adv implements Serializable {
	 ...
	 */
	public Circle_adv(Point2D_adv p, double r) {
		this.p = new Point2D_adv(p.getX(), p.getY());
		this.radius = r;
	}
	 ...
	 */
	public void move(Point2D_adv p) {
		this.p = new Point2D_adv(p.getX(), p.getY());
	}
	 ...
	 */
	public boolean equals(Circle_adv c) {
	 ...
	 */
	public boolean isInside(Point2D_adv p) {
	 ...
	 */
	public boolean isNear(Point2D_adv p) {
