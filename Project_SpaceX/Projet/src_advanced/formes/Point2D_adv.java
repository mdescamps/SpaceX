...
public class Point2D_adv implements Serializable {
     ...
     */
    public Point2D_adv(double x, double y) {
        this.x = x;
        this.y = y;
    }
     ...
     */
    public Point2D_adv(Point2D_adv p){
        this(p.x, p.y);
    }
     ...
     */
    public double distance(Point2D_adv p){
        double d1 = p.x - x;
        double d2 = p.y - y;
     ...
     */
    public boolean equals(Point2D_adv p) {
